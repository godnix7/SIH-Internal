...
export default function HelpScreen() {
  ...
  return (
    <Screen title={t('settings.help.title', 'Help & Support')} subtitle={t('settings.help.subtitle', 'We are here to assist you 24/7.')}>
      <Card style={{ marginBottom: space.md }}>
        <Text style={[type.subtitle, { color: c.onSurface, marginBottom: space.sm }]}>{t('settings.help.emergency', 'Emergency Assistance')}</Text>
        <ListRow 
      ...
      <Card>
        <Text style={[type.subtitle, { color: c.onSurface, marginBottom: space.sm }]}>{t('settings.help.appSupport', 'App Support')}</Text>
        <ListRow 
