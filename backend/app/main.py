...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "https://yatrishield.gov.in", "http://localhost:8081", "exp://127.0.0.1:8081", "https://sih-altf4.vercel.app", "https://sih-altf1.vercel.app"],
    allow_origin_regex=r"https://sih-altf.*\.vercel\.app",
