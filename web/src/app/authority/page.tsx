        ...
        >
          ...
          <div style={{ display: 'flex', gap: '12px' }}>
            ...
            >
              ...
              ></div>
              <span style={{ color: '#81C784', fontWeight: '600', fontSize: '14px' }}>
                Systems Optimal
              </span>
            </div>
          </div>
        ...
        >
          <div
            ...
            style={{
              ...
              borderRadius: '16px',
              background:
                'linear-gradient(145deg, rgba(33, 150, 243, 0.1), rgba(33, 150, 243, 0.02))',
          ...
          >
            ...
            <p style={{ fontSize: '40px', fontWeight: '800', color: '#FFFFFF', lineHeight: 1 }}>
              {analytics?.touristCount?.toLocaleString() || 0}
            </p>
          </div>
          ...
          >
            ...
            <p style={{ fontSize: '40px', fontWeight: '800', color: '#FFFFFF', lineHeight: 1 }}>
              {analytics?.activeTrips?.toLocaleString() || 0}
            </p>
          </div>
          ...
          <div
            ...
            style={{
              ...
              borderRadius: '16px',
              background:
                'linear-gradient(145deg, rgba(244, 67, 54, 0.1), rgba(244, 67, 54, 0.02))',
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'baseline', gap: '4px' }}>
              <p style={{ fontSize: '40px', fontWeight: '800', color: '#FFFFFF', lineHeight: 1 }}>
                {analytics?.averageResponseTimeSeconds || 0}
              </p>
              <span
                style={{
                  fontSize: '18px',
            ...
            >
              ...
              <div>
                ...
                <p style={{ fontSize: '14px', color: 'var(--color-text-secondary)' }}>
                  Push instant alerts to tourist devices.
                </p>
              </div>
            </div>
              ...
              <div className="input-group">
                ...
                >
                  <option value="all" style={{ background: '#1A1A1A' }}>
                    State-wide (All Regions)
                  </option>
                  <option value="north" style={{ background: '#1A1A1A' }}>
                    North District Only
                  </option>
                  <option value="south" style={{ background: '#1A1A1A' }}>
                    South District Only
                  </option>
                </select>
              </div>
              ...
              {broadcastSuccess && (
                ...
                >
                  ...
                  <span style={{ fontWeight: '500' }}>
                    Broadcast successfully dispatched to all active devices.
                  </span>
                </div>
              )}
            </div>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <p style={{ fontSize: '14px', color: 'var(--color-text-secondary)' }}>
                  Categorized breakdown of today&apos;s emergencies.
                </p>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  ...
                  ></div>
                  <span style={{ fontSize: '16px', fontWeight: '500', color: '#E0E0E0' }}>
                    Medical Emergencies
                  </span>
                </div>
                <span style={{ fontSize: '24px', fontWeight: '800', color: '#FFFFFF' }}>
                  {analytics?.incidentsByType?.medical || 0}
                </span>
              </div>
              ...
              >
                ...
                <span style={{ fontSize: '24px', fontWeight: '800', color: '#FFFFFF' }}>
                  {analytics?.incidentsByType?.police || 0}
                </span>
              </div>
              ...
              >
                ...
                <span style={{ fontSize: '24px', fontWeight: '800', color: '#FFFFFF' }}>
                  {analytics?.incidentsByType?.anomaly || 0}
                </span>
              </div>
            </div>
            ...
            >
              <p style={{ fontSize: '13px', color: 'var(--color-text-secondary)' }}>
                Data synchronizes securely with the blockchain ledger every 5 seconds.
              </p>
            </div>
          </div>
        </div>
