  ...
  const requestCameraPermission = async () => {
    ...
    try {
      ...
      if (err.name === 'NotAllowedError' || err.name === 'PermissionDeniedError') {
        ...
        setCameraPermissionError(
          'Could not access the camera. Error: ' + (err.message || err.name),
        );
      }
    } finally {
      setPermissionChecking(false);
      ...
      >
        {!isScanning && !scanResult && !loading && (
          ...
          >
            ...
            >
              Scan the Yatri Shield QR code on the patient&apos;s device or wristband to securely
              decrypt and view their medical history, blood type, and emergency contacts.
            </p>
        ...
        {scanResult && (
          ...
          >
              ...
              <div style={{ display: 'flex', gap: '24px', alignItems: 'center' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <p style={{ color: 'var(--color-on-surface-variant)', fontSize: '16px' }}>
                    DOB: {scanResult.dob || 'Unknown'} •{' '}
                    {scanResult.nationality || 'Nationality Unknown'}
                  </p>
                </div>
              </div>
            </div>
            ...
            {/* Medical Card */}
            <div
              style={{ padding: '32px', backgroundColor: 'rgba(var(--color-surface-rgb), 0.5)' }}
            >
              <div
                style={{
                  display: 'flex',
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
                ...
                >
                  ...
                  <div
                    style={{ fontSize: '32px', fontWeight: 'bold', color: 'var(--color-error)' }}
                  >
                    {scanResult.bloodGroup || 'Unknown'}
                  </div>
                </div>
                    ...
                    {scanResult.emergencyContacts.map((contact: any, idx: number) => (
                      ...
                      >
                        <div>
                          ...
                          <div
                            style={{ color: 'var(--color-on-surface-variant)', fontSize: '14px' }}
                          >
