    ...
    <main className="layout-container" style={{ alignItems: 'center', justifyContent: 'center', padding: '24px', flexDirection: 'column' }}>
      <div className="glass" style={{ padding: '48px', borderRadius: '16px', maxWidth: '800px', width: '100%', textAlign: 'center', marginBottom: '24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '24px' }}>
          <Link href="/login/responder" className="glass" style={{ padding: '32px 24px', borderRadius: '12px', transition: 'transform 0.2s', display: 'flex', flexDirection: 'column', alignItems: 'center', textDecoration: 'none' }}>
          ...
          <Link href="/login/hospital" className="glass" style={{ padding: '32px 24px', borderRadius: '12px', transition: 'transform 0.2s', display: 'flex', flexDirection: 'column', alignItems: 'center', textDecoration: 'none' }}>
            <span style={{ fontSize: '48px', marginBottom: '16px' }}>🏥</span>
          ...
          <Link href="/login/tourism" className="glass" style={{ padding: '32px 24px', borderRadius: '12px', transition: 'transform 0.2s', display: 'flex', flexDirection: 'column', alignItems: 'center', textDecoration: 'none' }}>
          ...
          <Link href="/login/admin" className="glass" style={{ padding: '32px 24px', borderRadius: '12px', transition: 'transform 0.2s', display: 'flex', flexDirection: 'column', alignItems: 'center', textDecoration: 'none' }}>
            <span style={{ fontSize: '48px', marginBottom: '16px' }}>⚙️</span>
