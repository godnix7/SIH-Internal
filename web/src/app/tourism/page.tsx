      ...
      >
        ...
        >
          ...
          <div className="glass" style={{ padding: '24px', borderRadius: '12px' }}>
            ...
            <div
              style={{
                ...
                fontWeight: '600',
                color:
                  analytics?.incidentsToday > 0 ? 'var(--color-error)' : 'var(--color-success)',
              }}
            >
          ...
          <div className="glass" style={{ padding: '24px', borderRadius: '12px' }}>
            ...
            <div style={{ fontSize: '32px', fontWeight: '600' }}>
              {analytics?.averageResponseTimeSeconds
                ? `${analytics.averageResponseTimeSeconds}s`
                : 'N/A'}
            </div>
            <div style={{ color: 'var(--color-success)', fontSize: '12px', marginTop: '4px' }}>
          ...
          >
            ...
            >
              ...
              <div style={{ fontSize: '20px', fontWeight: 'bold', marginTop: '4px' }}>
                {analytics?.incidentsBySeverity?.CRITICAL || 0}
              </div>
            </div>
            <div
              style={{
            ...
            >
              ...
              <div style={{ fontSize: '20px', fontWeight: 'bold', marginTop: '4px' }}>
                {analytics?.incidentsBySeverity?.HIGH || 0}
              </div>
            </div>
            <div
              style={{
            ...
            >
              ...
              <div style={{ fontSize: '20px', fontWeight: 'bold', marginTop: '4px' }}>
                {analytics?.incidentsBySeverity?.MODERATE || 0}
              </div>
            </div>
            <div
              style={{
            ...
            >
              ...
              <div style={{ fontSize: '20px', fontWeight: 'bold', marginTop: '4px' }}>
                {analytics?.incidentsBySeverity?.LOW || 0}
              </div>
            </div>
          </div>
        </div>
